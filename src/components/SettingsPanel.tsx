...
export function SettingsPanel({
  ...
  return (
    <div className="h-full flex flex-col lg:flex-row bg-zinc-50">
      <nav className="flex lg:flex-col lg:w-56 shrink-0 overflow-x-auto no-scrollbar border-b lg:border-b-0 lg:border-r border-zinc-200 bg-white py-2 lg:py-4">
        {([
          ["members", "👥 Family"],
          ["chores", "✅ Chores"],
          ["rewards", "🏆 Rewards"],
          ...
          <button
            key={key}
            onClick={() => setTab(key)}
            className={`shrink-0 whitespace-nowrap text-left px-4 lg:px-6 py-2.5 lg:py-3 text-sm lg:text-base rounded-full lg:rounded-none ${
